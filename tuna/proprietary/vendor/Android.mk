...
include $(CLEAR_VARS)
LOCAL_MODULE := libims.toro
LOCAL_MODULE_OWNER := samsung
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_TAGS := optional
LOCAL_INSTALLED_MODULE_STEM := libims$(LOCAL_MODULE_SUFFIX)
LOCAL_SRC_FILES := toro/lib/$(LOCAL_INSTALLED_MODULE_STEM)
LOCAL_MODULE_PATH := $(TARGET_OUT_VENDOR)/toro/lib
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_STRIP_MODULE := $(ANDROID_API_MM_OR_LATER)
...
include $(CLEAR_VARS)
LOCAL_MODULE := libims_jni.toro
LOCAL_MODULE_OWNER := samsung
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_TAGS := optional
LOCAL_INSTALLED_MODULE_STEM := libims_jni$(LOCAL_MODULE_SUFFIX)
LOCAL_SRC_FILES := toro/lib/$(LOCAL_INSTALLED_MODULE_STEM)
LOCAL_MODULE_PATH := $(TARGET_OUT_VENDOR)/toro/lib
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_STRIP_MODULE := $(ANDROID_API_MM_OR_LATER)
